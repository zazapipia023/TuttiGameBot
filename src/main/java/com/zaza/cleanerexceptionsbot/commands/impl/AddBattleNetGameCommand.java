...
public class AddBattleNetGameCommand implements Command<Long> {
    ...
    private void setAction(Long chatId) {
        log.info("Setting action \"add_battlenet_game\" to user: " + chatId);
        TelegramClient client = clientService.findOne(chatId);
        client.setAction("add_battlenet_game");
        clientService.save(client);
        log.info("Saved action \"add_battlenet_game\" to user: " + chatId);
    }
}
